...
public class AboutUsController {
	...
	public String addOrEditAboutUs(@ModelAttribute("aboutUs") AboutUs aboutUs, HttpSession session,
			...
			@RequestParam("fileaboutUs") MultipartFile[] fileaboutUs, HttpServletRequest request) {
		if (Common.isEmpty(aboutUs.getId())) {
			aboutUs.setId(null);
		}
		this.aboutUsService.saveOrUpdateAboutUs(aboutUs, session, file, fileaboutUs, oldaboutUs, imgPath,dir);
